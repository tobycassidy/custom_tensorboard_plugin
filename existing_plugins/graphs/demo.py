...
@tf.function
def init_model(model_to_init: tf.keras.models.Model, data_to_init_model: tf.python.framework.ops.EagerTensor):
...
def write_graph_summaries(log_dir: str,
                          ...
                          data_to_init_model: tf.python.framework.ops.EagerTensor):
