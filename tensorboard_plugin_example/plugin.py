"""A simple plugin to demonstrate dynamic loading of summaries."""
...
class ExamplePlugin(base_plugin.TBPlugin):
    ...
    def get_plugin_apps(self):
        return {
            ...
            "/NYC_mobility.html": self._serve_NYC_mobility,
            "/VAE_mnist.html": self._serve_VAE_mnist_html,
        }

    def frontend_metadata(self):
        return base_plugin.FrontendMetadata(es_module_path="/index.js", tab_name="PLOTLY")
    ...
    def _serve_js(self, _unused_request):
        return self._serve_static_file("index.js", "application/javascript")

    @werkzeug.Request.application
    def _serve_NYC_mobility(self, _unused_request):
        return self._serve_static_file("NYC_mobility.html", "text/html")

    @werkzeug.Request.application
    def _serve_VAE_mnist_html(self, _unused_request):
        return self._serve_static_file("VAE_mnist.html", "text/html")
